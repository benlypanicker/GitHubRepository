 ...
 */
public class RMTSAMPLEFLIGHTLoginAsyncTask extends AsyncTask<Void, Void, Boolean> 
{
	...
	private static final String TAG = "RMTSAMPLEFLIGHTLoginAsyncTask";
	 ...
	 */
	public RMTSAMPLEFLIGHTLoginAsyncTask(ILoginAsyncTask activity, Context context, String userName, String password, String vaultPassword, String vaultSalt) 
	{
	...
	protected Boolean doInBackground(Void... arg0) 
	{
		...
		try
        {
			result = RMTSAMPLEFLIGHTRequestHandler.getInstance(context).executeLoginUsernamePassword(userName, password, vaultPassword, vaultSalt);
        } 
